...
sys.path.insert(0, str(_REPO_ROOT / "JAYA_OS" / "src"))
sys.path.insert(0, str(_REPO_ROOT / "JAYA_AGENT" / "src"))
...
from contracts.core_agent_os_contract import (
    AgentToolRequest,
...
class TestOsBoundaryEnforcer:
    def test_boundary_ok_on_clean_repo(self):
        ...
        jaya_core_exists = (_REPO_ROOT / "JAYA_CORE").is_dir()
        jaya_agent_exists = (_REPO_ROOT / "JAYA_AGENT").is_dir()
