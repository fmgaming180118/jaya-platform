...
## 2026-08-14 - Persiapan initial proprietary release

### Changed

- Mengganti lisensi proyek MIT dengan ketentuan proprietary `All Rights
  Reserved`; penggunaan, modifikasi, redistribusi, dan training AI membutuhkan
  izin tertulis.
- Menutup kontribusi kode publik sampai pemilik menyediakan perjanjian
  kontribusi terpisah.
- Menyiapkan snapshot publik tanpa database, workspace, vector store, model
  generated, cache, object build, log build, dan artifact runtime.
- Menambahkan pengecualian eksplisit agar `.env.example` tetap dapat dilacak
  tanpa membuka `.env` nyata.

### Security

- Repository tetap private selama audit snapshot dan penulisan ulang history.
- Hak minimum pengguna GitHub saat repository public tetap mengikuti Ketentuan
  GitHub; lisensi proyek tidak memberikan hak tambahan.
