...
| RAG | Retrieval-Augmented Generation: jawaban dibuat dari konteks yang diambil |
| Reproducible | Pihak/run independen dapat menghasilkan hasil dalam tolerance yang ditetapkan |
| Simulation | Output sintetis/mock/random untuk pengembangan; bukan bukti empiris |
| Sovereign AI | AI yang data, model, izin, dan siklus hidupnya tetap dikontrol pengguna |
| Verified | Status setelah exit criteria, tests, benchmark, dan risiko utama dibuktikan |
| Workspace | Ruang terisolasi untuk sumber, index, percakapan, job, dan artefak pengguna |
