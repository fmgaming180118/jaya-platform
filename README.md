...
JAYA adalah perangkat lunak proprietary dengan seluruh hak cipta dilindungi.
Repository ini bukan proyek open source. Penggunaan, clone lokal, modifikasi,
eksekusi, redistribusi, karya turunan, dan training AI dilarang tanpa izin
tertulis, selain hak minimum yang diwajibkan oleh Ketentuan GitHub.

- [Kebijakan keamanan](docs/SECURITY.md)
- [Hak cipta dan ketentuan penggunaan](LICENSE)
