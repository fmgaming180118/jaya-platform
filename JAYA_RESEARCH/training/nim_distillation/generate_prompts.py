...
# Add JayaCore to path for potential self-analysis
...
def extract_concepts_from_jaya_docs() -> List[str]:
    ...
    doc_files = [
        ...
        JAYA_CORE_PATH / "docs" / "PHASE1_DECISION_LOG.md",
        JAYA_CORE_PATH / "docs" / "PHASE1_EXIT_CHECKLIST.md",
        JAYA_CORE_PATH / "docs" / "architecture.md",
    ]
