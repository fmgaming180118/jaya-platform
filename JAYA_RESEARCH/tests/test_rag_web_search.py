...
from src.research.enhanced_rag import EnhancedRAGClient
...
class TestRAGWebSearch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.research.enhanced_rag.NVIDIAEmbeddings', return_value=self.mock_embedder), \
             patch('src.research.enhanced_rag.VectorStore', return_value=self.mock_vector_store), \
             patch('src.research.enhanced_rag.WebSearchClient', return_value=self.mock_web_search):
