...
from JAYA_RESEARCH.src.research.multimodal_gold import GoldPDFCorpusLoader, GoldPDFDocument, RealOCRTableFigureProvider
...
def run_scientific_priorities_drill() -> dict:
    ...
    jurnal_dir = repo_root / "JAYA_RESEARCH" / "jurnal_pdf"
