...
def main():
    ...
    p.add_argument('--train-data', default='JAYA_RESEARCH/data/distillation/student_training_data.jsonl', help='Training data JSONL')
    p.add_argument('--out-dir', default='JAYA_RESEARCH/data/distillation/student-qwen-0.5b', help='Output directory')
    ...
    try:
        ...
        print("Install: pip install -r JAYA_RESEARCH/requirements-qlora.txt")
        return 1
