...
from JAYA_AGENT.src.contracts.core_agent_os_contract import (
    AgentToolRequest,
    ContractValidator,
    CoreToAgentDispatch,
)
from JAYA_AGENT.src.security.capability_sandbox import CapabilitySandbox
from JAYA_OS.src.jaya_os.consent_audit_manager import PermissionManager
...
async def run_agent_demo():
    ...
    sample_file_path = str((repo_root / "JAYA_RESEARCH" / "jurnal_pdf" / "sample.txt").resolve())
