...
from src.cognitive.runtime import JayaCoreRuntime  # noqa: E402
from src.security.cryptographic_skin import (  # noqa: E402
    CryptographicSkin,
...
def main() -> int:
    ...
    plaintext_absent = (
        payload not in database.read_bytes()
    ...
    result = {
        ...
        "old_key_revoked": revoked_code
        == CryptographicSkinFailureCode.KEY_REVOKED.value,
        "old_key_id": old_key,
        "new_key_id": new_key,
