"""Retired one-shot patch for `src/brain_v2/engine/runtime.py`."""
...
def main(argv: Sequence[str] | None = None) -> int:
    return retired_main(
        utility="_patch_runtime.py",
        target="src/brain_v2/engine/runtime.py",
        replacement="the runtime and readiness tests",
        argv=argv,
    )
