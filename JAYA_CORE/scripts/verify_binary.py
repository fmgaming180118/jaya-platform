...
try:
    import src.brain_v2.protection.soul_crypto as soul_crypto
    print(f"[+] Loaded SoulCrypto from: {soul_crypto.__file__}")
    
    import src.brain_v2.engine.agentic_search as agentic
    print(f"[+] Loaded AgenticSearch from: {agentic.__file__}")
    
    import src.brain_v2.format.serializer as serializer
