...
from src.os_kernel.feature_registry import FeatureRegistry, get_feature_registry
...
class Shell:
    ...
    async def compile_and_mount(self, scene: SceneGraph, feature_name: str = None,
        ...
        output_path = compile_scene_to_feature(scene, self.features_dir, feature_name)
