...
from .cognitive_agent_bridge import CognitiveAgentBridge, create_cognitive_agent_bridge, enhance_iron_engine_with_agent_bridge
...
__all__ = [
    ...
    "enhance_iron_engine_with_agent_bridge",
    "LocalLLMAdapter",
    "PublicAPIClient",
    "ConnectionManager",
]