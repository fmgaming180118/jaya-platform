...
from src.security.cryptographic_skin import CryptographicSkin, SealedEnvelope
...
class PersistentQuantumAuthority:
    ...
    def status(self) -> dict[str, object]:
        ...
        return {
            ...
            "versions": self._provider.versions(),
    ...
    def _load_or_create_active(self) -> tuple[OQSMLDSA65Provider, str]:
        row = self._connection.execute(
            """
    ...
    def _create_key(self) -> tuple[OQSMLDSA65Provider, str]:
