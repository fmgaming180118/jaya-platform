...
- Boundary resident `packages/jaya-core/src/jaya_core/brain_v2` dan home
  `packages/jaya-core/src/jaya_core/os_kernel` harus dipertahankan.
...
python packages\jaya-core\scripts\benchmark_phase1_ir.py --rounds 40 --gate --fail-on-gate
```
