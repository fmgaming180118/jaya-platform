...
except ImportError:  # direct legacy module execution compatibility
    from jaya_research.config import (  # type: ignore[no-redef]
        ResearchConfigurationError,
        ResearchSettings,
        get_settings,
    )
    ...
    def __init__(
        ...
        *,
        ...
        self.config_path = str(
            ...
            else canonical.base_dir / "configs" / "research" / "research_config.yaml"
        )
