...
PACKAGE_SOURCE_DIR = (
    Path(__file__).resolve().parents[1] / "src" / "jaya_research"
)

from jaya_research.provider_errors import (  # noqa: E402
    ProviderAuthError,
...
from jaya_research.research.academic.indonesia_sources import (  # noqa: E402
    CrossrefIndonesiaClient,
    GarudaClient,
)
from jaya_research.research.academic.journal_processor import JournalProcessor  # noqa: E402
from jaya_research.research.academic.literature import (  # noqa: E402
    ArxivClient,
    SemanticScholarClient,
)
from jaya_research.research.academic.novelty_checker import NoveltyChecker  # noqa: E402
from jaya_research.research.enhanced_rag import (  # noqa: E402
    EnhancedRAGClient,
    NVIDIAEmbeddings,
)
from jaya_research.research.web_search import WebSearchClient  # noqa: E402
...
def test_provider_sources_do_not_disable_tls_verification() -> None:
    source_files = [
        PACKAGE_SOURCE_DIR / "research" / "web_search.py",
        PACKAGE_SOURCE_DIR / "research" / "academic" / "literature.py",
        PACKAGE_SOURCE_DIR / "research" / "academic" / "indonesia_sources.py",
        PACKAGE_SOURCE_DIR / "research" / "enhanced_rag.py",
        PACKAGE_SOURCE_DIR / "research" / "video_processor.py",
        PACKAGE_SOURCE_DIR / "synthesize_knowledge.py",
    ]
