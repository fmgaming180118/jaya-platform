...
# Resolve the monorepo layout without workstation-specific paths.
PACKAGE_ROOT = Path(__file__).resolve().parents[1]
PROJECT_ROOT = Path(__file__).resolve().parents[3]
DATA_ROOT = (PROJECT_ROOT / "data" / "jaya-research").resolve(strict=False)
SRC_DIR = PACKAGE_ROOT / "src"
sys.path.insert(0, str(SRC_DIR))

from jaya_research.teacher import Teacher  # noqa: E402
...
def resolve_output_dir(raw_path: str | os.PathLike[str]) -> Path:
    """Keep generated research artifacts under the canonical Research data root."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="output directory under data/jaya-research",
    )
    return parser
