...
from jaya_core.os_kernel.intent_to_ui import IntentMatch
from jaya_core.brain_v2.engine.spec_generators import (
...
async def test_brain_to_house_end_to_end(tmp_path):
    ...
    from jaya_core.os_kernel.ui_spec import create_window as house_create_window, SceneGraph as HouseSceneGraph
    ...
    from jaya_core.os_kernel.feature_bridge import BridgeAction
