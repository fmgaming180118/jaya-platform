...
pytest.importorskip(
    "torch",
    reason="Phase 2 neural integration requires the optional Torch runtime",
)
...
from jaya_core.cognitive.contracts import Intent, IntentType
from jaya_core.cognitive.intent import IntentEngine
from jaya_core.cognitive.planner import GenericHierarchicalPlanner
from jaya_core.nlu import create_nlu_symbolic_bridge, NLUSymbolicBridge
from jaya_core.reasoning import create_symbolic_reasoner, SymbolicReasoner
from jaya_core.sandbox import SandboxManager, SubprocessSandbox
from jaya_agent.skills.base_skill import SkillRegistry
from jaya_core.neural import create_neural_symbolic_interface, TinyNeuralNet, TinyNetConfig
from jaya_core.self_improvement import (
    create_self_improvement_orchestrator,
    create_evolver_with_real_fitness,
    get_fitness_collector,
)
from jaya_core.verification import run_phase2_verification
...
class TestPhase2Integration:
    ...
    def executor(self):
        ...
        from jaya_core.security import get_capability_manager, Capability
        ...
        class SimpleExecutor:
            ...
            async def execute(self, plan):
                from jaya_core.sandbox.execution import ExecutionResult as SandboxExecutionResult, ExecutionStatus
    ...
    def neural_interface(self, neural_net):
        ...
        from jaya_core.capabilities.registry import CapabilityRegistry
        from jaya_core.capabilities.manifest import CapabilityManifest
        from jaya_core.neural.symbolic_interface import NeuralSymbolicInterface
        ...
        from jaya_core.neural.symbolic_interface import NeuralSymbolicConfig, SimpleTokenizer, TokenizerConfig
    ...
    def test_nlu_low_confidence_fallback(self, nlu_adapter, symbolic_reasoner):
        ...
        from jaya_core.nlu.symbolic_bridge import ClarificationNeeded
    ...
    def test_constraint_violation_handling(self, symbolic_reasoner):
        ...
        from jaya_core.cognitive.contracts import JayaIRRequest
        from jaya_core.reasoning.symbolic_reasoner import ConstraintViolation
    ...
    def test_sandbox_execution_failure(self, executor):
        ...
        from jaya_core.nlu.symbolic_bridge import SymbolicPlan
    ...
    def test_live_evolver_real_fitness(self):
        ...
        from jaya_core.self_improvement import create_evolver_with_real_fitness
    ...
    def test_morphic_kernel_real_patching(self):
        ...
        from jaya_core.self_improvement import MorphicKernel, MorphicPatch
    ...
    def test_morphic_kernel_config_patch(self):
        ...
        from jaya_core.self_improvement import MorphicKernel
    ...
    def test_fitness_functions_real(self):
        ...
        from jaya_core.self_improvement.fitness_functions import (
    ...
    def test_phase2_verification_gates(self):
        ...
        from jaya_core.verification.phase2_gates import run_phase2_verification
    ...
    def test_failure_path_constraint_violation(self, symbolic_reasoner):
        ...
        from jaya_core.cognitive.contracts import JayaIRRequest, ActionPlan, ActionStep, RiskClass
