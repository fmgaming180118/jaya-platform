...
from jaya_core.os_kernel.feature_registry import get_feature_registry
...
from jaya_core.os_kernel.ui_spec import SceneGraph
...
class Shell:
    ...
    async def compile_and_mount(self, scene: SceneGraph, feature_name: str = None,
        ...
        # Compile
        from jaya_core.os_kernel.feature_compiler import compile_scene_to_feature
...
class ShellIntegration:
    ...
    async def _handle_create_window(self, params: Dict) -> Dict[str, Any]:
        from jaya_core.os_kernel.ui_spec import WindowGeometry
        geometry = None
