...
from jaya_core.brain_v2.engine.jaya_ir_translator import logic_expr_to_ir
...
from jaya_core.brain_v2.soul.lingua_logica import LogicExpr
from jaya_core.capabilities.puzzle import (
    CapabilityPuzzleRegistry,
    PuzzleError,
    PuzzleFailureCode,
)
from jaya_core.reasoning.pure_logic import PureLogicError
