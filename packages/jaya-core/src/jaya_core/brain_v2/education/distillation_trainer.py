...
class DistillationTrainer:
    ...
    def save_log(self, log_file: Path = TRAIN_LOG_FILE) -> None:
        ...
        log_file.write_text(
            json.dumps(self._loss_history, indent=2),
            encoding="utf-8",
        )
...
if __name__ == "__main__":
    ...
    from jaya_core.brain_v2.education.distillation_dataset import DistillationDataset
    from jaya_core.brain_v2.education.indonesian_corpus import IndonesianCorpus
    from jaya_core.brain_v2.education.indonesian_tokenizer import (
        IndonesianTokenizer,
        _train_and_save,
    )
    from jaya_core.brain_v2.model.nano_inference import INDONESIAN_CONFIG, NanoModel
