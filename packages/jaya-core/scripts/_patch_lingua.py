"""Retired one-shot patch for `src/brain_v2/soul/lingua_logica.py`."""
...
def main(argv: Sequence[str] | None = None) -> int:
    return retired_main(
        utility="_patch_lingua.py",
        target="src/brain_v2/soul/lingua_logica.py",
        replacement="the LinguaLogica tests",
        argv=argv,
    )
