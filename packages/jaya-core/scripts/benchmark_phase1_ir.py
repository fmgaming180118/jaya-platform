...
Usage:
    python packages/jaya-core/scripts/benchmark_phase1_ir.py
"""
...
BENCHMARK_REPORT_ROOT = (WORKSPACE_ROOT / "outputs" / "reports" / "benchmarks").resolve(
    strict=False
)
